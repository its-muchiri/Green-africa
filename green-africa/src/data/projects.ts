...
export const projects: Project[] = [
  {
    ...
    description:
      "Designed and installed 8 school kitchen gardens (0.1–0.3 ha each) aligned with feeding programme calendars. Integrated raised beds, vertical towers, drip irrigation, rainwater harvesting (10,000 L tanks), and compost zones. Crops: amaranth, nightshade, spinach, kale, carrots, beetroot — harvested term-time. World Vision funded; 12-month maintenance contract with quarterly replanting.",
    images: [
      "/images/project-kajiado-school-01.jpg",
      "/images/project-kajiado-school-02.jpg",
      "/images/project-kajiado-school-03.jpg",
    ],
  ...
  },
  {
    ...
    images: [
      "/images/project-laikipia-pond-01.jpg",
      "/images/project-laikipia-pond-02.jpg",
    ],
  ...
  },
  {
    ...
    description:
      "12 wooden-frame greenhouses (8×24 m) for tomato (Anna F1) production by a youth cooperative. Complete kits: treated eucalyptus frames, 200-micron UV polythene, 40-mesh insect netting, drip irrigation, venturi fertigation. 3-cycle/year calendar with 2-week turnaround. Cooperative aggregates produce for Nairobi wholesale. 2,300+ kg/tunnel/cycle average.",
    images: [
      "/images/project-kiambu-greenhouse-01.jpg",
      "/images/project-kiambu-greenhouse-02.jpg",
    ],
  ...
  },
  {
    ...
    category: "Structures",
    description:
      "2,000 m² shade net structure (50% green, 75% black zones) for grafted fruit tree nursery — avocado (Hass, Fuerte), mango (Apple, Kent), macadamia. Galvanized steel frame, cable-tensioned, automated misting propagation beds, hardening zone. Capacity: 50,000 seedlings/year. KEPHIS certified. Supplies county agroforestry programme and private farms.",
    images: [
      "/images/project-machakos-nursery-01.jpg",
      "/images/project-machakos-nursery-02.jpg",
    ],
